...
const Footer = () => {
  ...
  <div className="py-20 bg-black border-t border-white w-[85%] m-auto">
    <div className="container mx-auto flex flex-col items-center">
      <h3 className="text-xl font-semibold mb-4">Tu opinión nos interesa</h3>
      <p className="text-white mb-4">Por favor, comparte tus sugerencias o comentarios acerca de la página:</p>

      <form className="w-full max-w-md">
        <div className="mb-4">
          <label htmlFor="email" className="block text-white text-sm mb-2">Email:</label>
          <input type="email" id="email" name="email" className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-indigo-500" placeholder="Ingresa tu email" required />
        </div>

        <div className="mb-4">
          <label htmlFor="comment" className="block text-white text-sm mb-2">Comentario:</label>
          <textarea id="comment" name="comment" className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-indigo-500" placeholder="Escribe tu comentario" required></textarea>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex">
            <div className="mr-2">
              ...
              <label htmlFor="star1" className="text-red-600">&#9733;</label>
            </div>
            <div className="mr-2">
              <input type="radio" id="star2" name="rating" value="2" />
              <label htmlFor="star2" className="text-red-600">&#9733;</label>
            </div>
            <div className="mr-2">
              <input type="radio" id="star3" name="rating" value="3" />
              <label htmlFor="star3" className="text-red-600">&#9733;</label>
            </div>
            <div className="mr-2">
              <input type="radio" id="star4" name="rating" value="4" />
              <label htmlFor="star4" className="text-red-600">&#9733;</label>
            </div>
            <div>
              <input type="radio" id="star5" name="rating" value="5" />
              <label htmlFor="star5" className="text-red-600">&#9733;</label>
            </div>
          </div>
        </div>

        <button type="submit" className="bg-red-600 hover:bg-white hover:text-black text-white py-2 px-4 rounded">Enviar</button>
      </form>
    </div>
  </div>
</div>
